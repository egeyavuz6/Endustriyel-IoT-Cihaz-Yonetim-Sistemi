...
TEMPERATURE_ALARM_THRESHOLD = 75.0
...
class TelemetryGenerator:
    ...
    def generate(self, device_id):
        ...
        for field in self.fields_config:
            ...
            if field["name"] == "temperature" and value > TEMPERATURE_ALARM_THRESHOLD:
                logger.warning(f"Device_{device_id}  Sıcaklık yüksek! ({value}°C) Alarm oluşturuluyor...")
